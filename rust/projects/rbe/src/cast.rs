...
fn main() {
	...
	/* This behavior incures a small runtime cost and can be
	 * avoided with unsafe methods, however the results might
	 * overflow and return **unsound values**. Use these methods
	 * wisely:
	 */
	unsafe {
		// 300.0 is 44
